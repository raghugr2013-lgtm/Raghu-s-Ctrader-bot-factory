...
class DiversityEngine:
    ...
    def analyze_and_filter(
        ...
        logger.info(f"[DIVERSITY ENGINE] Analyzed {total} strategies")
        logger.info(f"[DIVERSITY ENGINE] Categories: {dict(category_counts)}")
        logger.info(f"[DIVERSITY ENGINE] Diversity Score: {diversity_score:.1f}/100")
        logger.info(f"[DIVERSITY ENGINE] Filtered: {total} → {len(filtered)}")
